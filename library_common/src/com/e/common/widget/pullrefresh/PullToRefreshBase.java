...
import com.e.common.utility.CommonUtility.CalendarUtility;
import com.e.common.utility.CommonUtility.DebugLog;
import com.e.common.widget.pullrefresh.ILoadingLayout.State;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
	...
	public interface OnRefreshListener<V extends View> {
		 ...
		 *            刷新的View
		 */
		void onPullUpToLoadMore(final PullToRefreshBase<V> refreshView);
	}
	...
	protected void startLoading() {
		...
		if (null != mRefreshListener) {
			...
			postDelayed(new Runnable() {
				@Override
				public void run() {
					mRefreshListener.onPullUpToLoadMore(PullToRefreshBase.this);
				}
			}, getSmoothScrollDuration());
		}
	}
	...
	public void setLastUpdateTime() {
		String text = CalendarUtility.getCurrentDate(0, 16);
