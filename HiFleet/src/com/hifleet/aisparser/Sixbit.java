...
public class Sixbit {
    ...
    public long get(int numbits)
        ...
        while (fetch_bits > 0) {    
            //System.out.println("remainderLength: "+this.remainderLength);
            ...
            if (this.bitsIndex < this.bits.length()) {
               // System.out.println("bitsIndex: "+this.bitsIndex+", bitsLength: "+this.bits.length());
               // p("the bits char: "+bits.charAt(this.bitsIndex));
                this.remainder = binfrom6bit((int) bits.charAt(this.bitsIndex));//灏嗗叾杞崲涓�杩涘埗
              //  p("this.remainder: "+remainder);
                this.bitsIndex++;
                if (this.bitsIndex == this.bits.length()) {
       ...
       // System.out.println("final return result this.remainderLength: "+this.remainderLength);
        return result;
    }
