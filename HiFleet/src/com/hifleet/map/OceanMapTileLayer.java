...
public class OceanMapTileLayer extends BaseMapLayer {
	...
	public OceanMapTileLayer(boolean mainMap){
...
//			}
 ...
 public static final String TAG = "FileDownloader";
	...
	public void onPrepareBufferImage(Canvas canvas, RotatedTileBox tileBox,
		...
		if(app.myPreferences.getBoolean("IsShowOcean",
				false)&&tileBox.getZoom()<=7){
...
//		System.err.println("刷wave图结束*************发出通知 ");	
//		for(DMapRefreshCallback call :new ArrayList<DMapRefreshCallback>(calls)){
//			call.dotmapRefreshed(tileBox);
//		}
	}
